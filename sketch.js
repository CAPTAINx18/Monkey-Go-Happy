var monkey , monkey_running, monkeyCollide, ground, invisiGround, groundImg, banana, bananaImage, obstacle, obstacleImage, FoodGroup, obstacleGroup;
...
function draw(){
  ...
  fill("black");
  text("Survived: " + score, 470, 20);
  text("Bananas count: " + ban_coll, 300, 20);
 ...
 // stroke("red")
    textSize(30);
    text("Game is over Dude", 180, 160);
